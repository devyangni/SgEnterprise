...
import com.sgenterprises.Adapter.Adapter_order;
...
public class OrderListFragment extends Fragment {
    ...
    private String date = "";
    public static Adapter_order adapter_events;
    String TAG = BookedOrderListFragment.class.getName();
    List<UserDatum> data = new ArrayList<>();
    ...
    private AutoCompleteTextView datepicker_order;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        parentView = inflater.inflate(R.layout.activity_order_alllisting, container, false);
    ...
    private void findViews() {
        ...
        datepicker_order = (AutoCompleteTextView) parentView.findViewById(R.id.name);
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (success.equalsIgnoreCase("true")) {
                                ...
                                if (data.size() > 0) {
                                    ...
                                    adapter_events = new Adapter_order(getActivity(), data, recyclerList);
