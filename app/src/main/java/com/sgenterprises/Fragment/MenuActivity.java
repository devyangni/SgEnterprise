...
public class MenuActivity extends FragmentActivity implements View.OnClickListener{
    ...
    private ResideMenuItem itemHomea;
    ...
    private ResideMenuItem itemservices;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        setUpMenu();
        commonSession = new CommonSession(MenuActivity.this);
        try {
            ...
            if (CommonUtils.isTextAvailable(userId) ) {
                ...
                itemHomea.setVisibility(View.VISIBLE);
            ...
            {
                if( savedInstanceState == null )
                    menuheader.setText(getResources().getString(R.string.app_name));
                    changeFragment(new HomeFragment());
                itemloginreg.setVisibility(View.VISIBLE);
                itemLogout.setVisibility(View.GONE);
                itemHomea.setVisibility(View.GONE);
    ...
    private void setUpMenu() {
        ...
        resideMenu.setBackground(R.drawable.build);
       ...
       // itemHome     = new ResideMenuItem(this, R.drawable.home, mContext.getResources().getString(R.string.updateprofile));
        itemHomea     = new ResideMenuItem(this, R.drawable.home, mContext.getResources().getString(R.string.updateprofile));
        itemloginreg  = new ResideMenuItem(this, R.drawable.login,  mContext.getResources().getString(R.string.login));
        itemorderbooking  = new ResideMenuItem(this, R.drawable.material_order,  mContext.getResources().getString(R.string.Profile));
        itemorderlisting = new ResideMenuItem(this, R.drawable.list, mContext.getResources().getString(R.string.OrderListing));
        itembookedorderlisting = new ResideMenuItem(this, R.drawable.list,mContext.getResources().getString(R.string.BookedOrders));
        itemservices = new ResideMenuItem(this, R.drawable.about_us,mContext.getResources().getString(R.string.services));
       ...
       // itemHome.setOnClickListener(this);
        itemHomea.setOnClickListener(this);
        ...
        resideMenu.addMenuItem(itemHomea, ResideMenu.DIRECTION_LEFT);
        ...
        resideMenu.addMenuItem(itemservices, ResideMenu.DIRECTION_LEFT);
...
//        });
    ...
    public void onClick(View view) {
        ...
        if (view == itemHome) {
            ...
            try {
                ...
                if (CommonUtils.isTextAvailable(userId) ) {
                    ...
                    menuheader.setText(getResources().getString(R.string.OrderListing));
                    changeFragment(new OrderListFragment());
                }
                else
                {

                    showImageDialog(MenuActivity.this);
            ...
            try {
                ...
                if (CommonUtils.isTextAvailable(userId) ) {
                    ...
                    menuheader.setText(getResources().getString(R.string.BookedOrders));
                    changeFragment(new BookedOrderListFragment());
                }
                else
                {
        ...
        }else if (view == itemservices){

            menuheader.setText(getResources().getString(R.string.services));
