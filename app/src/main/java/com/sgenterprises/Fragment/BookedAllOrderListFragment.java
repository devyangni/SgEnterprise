...
import com.sgenterprises.Adapter.Adapter_bookedall;
...
public class BookedAllOrderListFragment extends Fragment {
    ...
    private String date="";
    public  static Adapter_bookedall adapter_events;
    String TAG = BookedAllOrderListFragment.class.getName();
  public  static   List<bookedlistdata> data = new ArrayList<>();
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if ( success.equalsIgnoreCase("true")) {
                                ...
                                if (data.size() > 0) {
                                    ...
                                    adapter_events = new Adapter_bookedall(getActivity(), data,recyclerList);
