...
public class AdminUpdateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        parentView = inflater.inflate(R.layout.fragmentuser, container, false);
            ...
            if (resultCode == RESULT_OK && requestCode == PICK_FROM_GALLARY) {
                ...
                try {
                    if (data != null) {
                        ...
                        CompressImageUtil compressUtil = new CompressImageUtil(getContext());
...
*/
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(first_name)) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.enterfname));
                } else if (TextUtils.isEmpty(last_name)) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.enterfname));
                } else if (TextUtils.isEmpty(Company)) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.entercname));
                } else if (TextUtils.isEmpty(phone_no)) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.entermobno));
                } else if (phone_no.length() != 10) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.entervmobno));
                } else if (TextUtils.isEmpty(emailid)) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.enteremailid));

                } else if (!CommonUtils.isEmailValid(emailid)) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.validemail));

                } else if (TextUtils.isEmpty(passwordd)) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.enterpassword));
                } else if (passwordd.length() < 6) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.minpassword));
                } else if (TextUtils.isEmpty(cpasswordd)) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.entercpassword));
                } else if (!passwordd.toString().equals(cpasswordd.toString())) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.validcpassword));
                } else if (!CommonUtils.isTextAvailable(address)) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.enteradd));
                } else if (address.length() < 10) {
                    CommonUtils.commonToast(getActivity(), getResources().getString(R.string.entervadd));
                } else {
                    try {
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (success.equalsIgnoreCase("true")) {
                                ...
                                showImageDialog(response.body().getError(),getActivity());
    ...
    private void findViews() {
        profile = (TextView) parentView.findViewById(R.id.profile);
        edtFname = (EditText) parentView.findViewById(R.id.edt_fname);
        edtLname = (EditText) parentView.findViewById(R.id.edt_lname);
        edtCompany = (EditText) parentView.findViewById(R.id.edt_companyname);
        email = (EditText) parentView.findViewById(R.id.email);
        password = (EditText) parentView.findViewById(R.id.password);
        cpassword = (EditText) parentView.findViewById(R.id.cpassword);
        edtAddress = (EditText) parentView.findViewById(R.id.edt_address);
        edtCity = (EditText) parentView.findViewById(R.id.edt_city);
        edtState = (EditText) parentView.findViewById(R.id.edt_state);
        edtZip = (EditText) parentView.findViewById(R.id.edt_zip);
        edtfile = (EditText) parentView.findViewById(R.id.edtfile);
        edtprofile = (TextView) parentView.findViewById(R.id.edtprofile);
        btnUpload = (Button) parentView.findViewById(R.id.btn_upload);
        btnLogin = (Button) parentView.findViewById(R.id.btn_login);
        edtprofile.setVisibility(View.VISIBLE);
        btnLogin.setVisibility(View.GONE);

        imagProfile = (CircleImageView) parentView.findViewById(R.id.imag_profile);
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showImageDialog1(getActivity());
            }
        });
