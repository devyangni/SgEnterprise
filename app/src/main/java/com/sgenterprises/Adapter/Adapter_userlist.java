...
import com.sgenterprises.Home.UpdateProfileActivity;
...
public  class Adapter_userlist extends RecyclerView.Adapter {
    ...
    public Adapter_userlist(FragmentActivity mFragmentActivity, List<UserList> mlist, RecyclerView rv_events) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            viewHolder.pos = position;
                UserList list = mlist.get(position);
            
            String id = list.getUserId();
            String  date=list.getCompanyName();
            String  customername =list.getEmail();
            String materialName =list.getPhoneNo();
        ...
        public ViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i = new Intent(mFragmentActivity,UpdateProfileActivity.class);
                    i.putExtra("list",mlist.get(pos).getUserId());
