...
import com.sgenterprises.Home.User.OrderListdetailuser;
...
public  class Adapter_orderall extends RecyclerView.Adapter {
    ...
    public  List<UserDatum> mlist = new ArrayList<>();

    public Adapter_orderall(FragmentActivity mFragmentActivity, List<UserDatum> mlist, RecyclerView rv_events) {
...
*/
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            String  customername =list.getFirstName();
           ...
           SimpleDateFormat spf = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
            ...
            SimpleDateFormat spf_date = new SimpleDateFormat("dd-MM-yyyy");
        ...
        public ViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                     ...
                     Intent i = new Intent(mFragmentActivity,OrderListdetailuser.class);
