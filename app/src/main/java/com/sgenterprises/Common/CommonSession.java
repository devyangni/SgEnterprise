...
public class CommonSession {
    ...
    private static final String LOGIN_USER_STATUS = "LOGIN_USER_STATUS";
    private static final String LOGIN_EMAIL_STATUS = "LOGIN_email_STATUS";
    private static final String FACEBOOKID = "facebookid";
    private static final String FACEBOOKPHOTO = "fbpic";
    ...
    private static final String SENDER_ANDROID_LINK = "senderandroidLink";
    private static final String SENDER_SHARE_MESSAGE = "senderShareMessage";
    private static final String CONTACT_US_MOBILE = "contactUsMobile";
    private static final String CONTACT_US_PHONE = "contactUsPhone";
    private static final String SENDER_COST_URL= "sender_cost_url";
    private static final String SENDER_PAYMENT_URL = "sender_payment_url";
    ...
    public  String getLoginUserStatus() {
        return sharedPref.getString(LOGIN_USER_STATUS, null);
    }

    public void setLoginUserStatus(String login_id) {
        try {
            editor.putString(LOGIN_USER_STATUS, login_id);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void resetLoginUserStatus() {
        try {
            editor.putString(LOGIN_USER_STATUS, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public  String getLoginEmailStatus() {
        return sharedPref.getString(LOGIN_EMAIL_STATUS, null);
    }

    public void setLoginEmailStatus(String login_id) {
        try {
            editor.putString(LOGIN_EMAIL_STATUS, login_id);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void resetLoginEmailStatus() {
        try {
            editor.putString(LOGIN_EMAIL_STATUS, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public  String getFacebookid() {
        return sharedPref.getString(FACEBOOKID, null);
    }

    public void setFacebookid(String login_id) {
        try {
            editor.putString(FACEBOOKID, login_id);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void resetFacebookid() {
        try {
            editor.putString(FACEBOOKID, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public  String getActivityType() {
        return sharedPref.getString(ACTIVITYTYPE, null);
    }

    public void setActivityType(String login_id) {
        try {
            editor.putString(ACTIVITYTYPE, login_id);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void resetActivityType() {
        try {
            editor.putString(ACTIVITYTYPE, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public  String getFacebookphoto() {
        return sharedPref.getString(FACEBOOKPHOTO, null);
    }

    public void setFacebookphoto(String login_id) {
        try {
            editor.putString(FACEBOOKPHOTO, login_id);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void  resetFacebookphoto() {
        try {
            editor.putString(FACEBOOKPHOTO, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String getSenderAndroidLink() {
        return sharedPref.getString(SENDER_ANDROID_LINK, null);
    }

    public void setSenderAndroidLink(String SenderAndroidLink) {

        try {
            editor.putString(SENDER_ANDROID_LINK, SenderAndroidLink);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void resetSenderAndroidLink() {
        try {
            editor.putString(SENDER_ANDROID_LINK, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String getSenderShareMessage() {
        return sharedPref.getString(SENDER_SHARE_MESSAGE, null);
    }

    public void setSenderShareMessage(String ShareMessage) {

        try {
            editor.putString(SENDER_SHARE_MESSAGE, ShareMessage);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void resetSenderShareMessage() {
        try {
            editor.putString(SENDER_SHARE_MESSAGE, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//
    public String getContactUsMobile() {
        return sharedPref.getString(CONTACT_US_MOBILE, null);
    }

    public void setContactUsMobile(String mb) {

        try {
            editor.putString(CONTACT_US_MOBILE, mb);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void resetContactUsMobile() {
        try {
            editor.putString(CONTACT_US_MOBILE, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String getContactUsPhone() {
        return sharedPref.getString(CONTACT_US_PHONE, null);
    }

    public void setContactUsPhone(String phn) {

        try {
            editor.putString(CONTACT_US_PHONE, phn);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void resetContactUsPhone() {
        try {
            editor.putString(CONTACT_US_PHONE, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static final String SENDER_PAYMENT_URL = "sender_payment_url";*/
    //
    public String getSenderCostUrl() {
        return sharedPref.getString(SENDER_COST_URL, null);
    }

    public void setSenderCostUrl(String url) {

        try {
            editor.putString(SENDER_COST_URL, url);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void resetSenderCostUrl() {
        try {
            editor.putString(SENDER_COST_URL, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    //
    public String getSenderPaymentUrl() {
        return sharedPref.getString(SENDER_PAYMENT_URL, null);
    }

    public void setSenderPaymentUrl(String url) {

        try {
            editor.putString(SENDER_PAYMENT_URL, url);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void resetSenderPaymentUrl() {
        try {
            editor.putString(SENDER_PAYMENT_URL, null);
            editor.commit();
        } catch (Exception e) {
            e.printStackTrace();
        }
